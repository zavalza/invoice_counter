defmodule InvoiceCounterTest do
  use ExUnit.Case
  ...
  test "returns the result of both accumulators after request finish" do
    response = count("--some-company-id--")
  ...
  defp could_not_count_invoices(company_id, start_date, finish_date) do
    InvoiceCounter.could_not_count_invoices(company_id, start_date, finish_date, FakeInvoiceStore, FakeAccumulator)
  end
